  ...
  return (
    <div className={styles['container']}>
      <div className={styles['header']}>
        ...
        >
          <span className={projectStyles['logo']}>AI-TECH</span>
        ...
        <div className={projectStyles['features-container']}>
          <div className={styles['features1']}>
            <div className={styles['container02']}>
              ...
              >
                <span>
                  <span>
                    <span>
                      Unlock the potential of AI with these amazing features
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className={styles['container03']}>
              ...
              <FeatureCard
                heading="Feature 3"
                subHeading="Description of feature 3"
              ></FeatureCard>
              <FeatureCard
                heading="Feature 4"
                subHeading="Description of feature 4"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <span>
              <span>
                <span>
                  AI Solutions is a leading provider of cutting-edge artificial
                  intelligence solutions for businesses of all sizes. Our
                  advanced AI technologies are designed to help you streamline
                  operations, enhance customer experiences, and drive growth.
                  With our expertise in machine learning, natural language
                  processing, and computer vision, we can help you unlock the
                  full potential of AI for your organization.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
        ...
        <div className={projectStyles['faq-container']}>
          <div className={styles['faq1']}>
            ...
            <div className={styles['container30']}>
              <Question1
                answer="AI stands for Artificial Intelligence, which refers to the simulation of human intelligence in machines that are programmed to think and learn like humans."
                question="What is AI?"
              ></Question1>
              <Question1
                answer="AI works by using algorithms and data to enable machines to perform tasks that typically require human intelligence. It involves processes such as machine learning, natural language processing, and computer vision."
                question="How does AI work?"
              ></Question1>
              <Question1
                answer="AI has various applications across different industries, including healthcare, finance, transportation, retail, and more. It can be used for tasks such as data analysis, predictive modeling, virtual assistants, autonomous vehicles, and personalized recommendations."
                question="What are the applications of AI?"
              ></Question1>
              <Question1
                answer="While AI has the potential to automate certain tasks and job roles, it is not necessarily replacing humans entirely. Instead, it is transforming the way we work by augmenting human capabilities and enabling us to focus on more complex and creative tasks."
                question="Is AI replacing human jobs?"
              ></Question1>
              <Question1
                answer="AI safety is an important consideration in its development. While there are concerns about potential risks and ethical implications of AI, researchers and organizations are actively working on ensuring the safe and responsible use of AI technology."
                question="Is AI safe?"
              ></Question1>
            </div>
          </div>
